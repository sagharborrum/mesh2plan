#!/usr/bin/env python3
"""
mesh2plan v92 - v90 rooms + rasterized orthogonal boundary

Strategy: Take room OBBs in rotated space (where walls are H/V), rasterize them
on a coarse grid, extract the outer contour → guaranteed rectilinear.
"""
...
def main():
    ...
    plt.tight_layout()
    out = '/tmp/v92_raster_boundary.png'
